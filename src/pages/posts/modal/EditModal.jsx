...
function EditModal({ data, setData, editModal, setEditModal, Alert, setAlert, schoolId }) {
    ...
    const telegramSending = (bool, postid) => {
        axiosInstance.get(`/Posts/AccessForTelegramChannel?postid=${postid}&allow=${bool}`)
            .then((res) => {
                axiosInstance.get(`/Posts/GetSeenSchoolPosts??limit=10&page=1&schoolid=${schoolId}`)
                    .then((res) => {
                    ...
                    <div className="modal-body pb-2">
                        <form>
                            <div className="row">
                                ...
                                {
                                    data1?.telegramSending === 3 && (
                                        <div className="col-lg-12">
                                            <div className="mb-3">
                                                <div className="form-control">
                                                    <label className='text-primary'><b>Telegram</b></label> <br />
                                                    <label for="floatingInput">Siz ushbu postni rasmiy telegram kanalga chiqarish uchun ruxsat berdingiz</label>
                                                </div>
                                            </div>
                                        </div>
                                    )
                                    ...
                                    data1?.webSending === 3 && (
                                        <div className="col-lg-12">
                                            <div className="mb-3">
                                                <div className="form-control">
                                                    <label className='text-primary'><b>Web sayt</b></label> <br />
                                                    <label for="floatingInput">Siz ushbu postni rasmiy web saytga chiqarish uchun ruxsat berdingiz</label>
                                                </div>
                                            </div>
                                        </div>
                                    )
                                ...
                                {
                                    data1?.telegramSending === 4 && (
                                        <div className="col-lg-12">
                                            <div className="mb-3">
                                                <div className="form-control">
                                                    <label className='text-primary'><b>Telegram</b></label> <br />
                                                    <label for="floatingInput">Siz ushbu postni telegram kanalga chiqarishni taqiqladingiz</label>
                                                </div>
                                            </div>
                                        </div>
                                    )
                                    ...
                                    data1?.webSending === 4 && (
                                        <div className="col-lg-12">
                                            <div className="mb-3">
                                                <div className="form-control">
                                                    <label className='text-primary'><b>Web sayt</b></label> <br />
                                                    <label for="floatingInput">Siz ushbu postni rasmiy web saytga chiqarishni taqiqladingiz</label>
                                                </div>
                                            </div>
                                        </div>
                                    )
                                ...
                                {
                                    data1?.telegramSending === 5 && (
                                        <div className="col-lg-12">
                                            <div className="mb-3">
                                                <div className="form-control">
                                                    <label className='text-primary'><b>Telegram</b></label> <br />
                                                    <label for="floatingInput">
                                                        Ushbu post telegram kanalda e`lon sifatida muvaffaqiyatli uzatilgan.
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
